...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{images/step3_results/part_a/part_a_unconditional.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{images/step3_results/part_b/part_b_space_exploration_simple.png}
    \includegraphics[width=0.3\textwidth]{images/step3_results/part_b/part_b_space_exploration_medium.png}
    \includegraphics[width=0.3\textwidth]{images/step3_results/part_b/part_b_space_exploration_detailed.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{images/step3_results/part_b/part_b_underwater_world_simple.png}
    \includegraphics[width=0.3\textwidth]{images/step3_results/part_b/part_b_underwater_world_medium.png}
    \includegraphics[width=0.3\textwidth]{images/step3_results/part_b/part_b_underwater_world_detailed.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{images/step3_results/part_b/part_b_ancient_architecture_simple.png}
    \includegraphics[width=0.3\textwidth]{images/step3_results/part_b/part_b_ancient_architecture_medium.png}
    \includegraphics[width=0.3\textwidth]{images/step3_results/part_b/part_b_ancient_architecture_detailed.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{images/step3_results/part_b/part_b_futuristic_city_simple.png}
    \includegraphics[width=0.3\textwidth]{images/step3_results/part_b/part_b_futuristic_city_medium.png}
    \includegraphics[width=0.3\textwidth]{images/step3_results/part_b/part_b_futuristic_city_detailed.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{images/step3_results/part_b/part_b_fantasy_creatures_simple.png}
    \includegraphics[width=0.3\textwidth]{images/step3_results/part_b/part_b_fantasy_creatures_medium.png}
    \includegraphics[width=0.3\textwidth]{images/step3_results/part_b/part_b_fantasy_creatures_detailed.png}
...
\begin{figure*}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{images/step3_results/part_d/part_d_cfg_0.0.png}
    \includegraphics[width=0.3\textwidth]{images/step3_results/part_d/part_d_cfg_2.0.png}
    \includegraphics[width=0.3\textwidth]{images/step3_results/part_d/part_d_cfg_5.0.png}\\
    \includegraphics[width=0.3\textwidth]{images/step3_results/part_d/part_d_cfg_8.0.png}
    \includegraphics[width=0.3\textwidth]{images/step3_results/part_d/part_d_cfg_12.0.png}
    \includegraphics[width=0.3\textwidth]{images/step3_results/part_d/part_d_cfg_15.0.png}
