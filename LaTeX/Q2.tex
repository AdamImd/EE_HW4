...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.19\textwidth]{../results/step2_results/mnist_cg_0.0.png}
    \includegraphics[width=0.19\textwidth]{../results/step2_results/mnist_cg_1.0.png}
    \includegraphics[width=0.19\textwidth]{../results/step2_results/mnist_cg_3.0.png}
    \includegraphics[width=0.19\textwidth]{../results/step2_results/mnist_cg_5.0.png}
    \includegraphics[width=0.19\textwidth]{../results/step2_results/mnist_cg_10.0.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.19\textwidth]{../results/step2_results/mnist_cfg_0.0.png}
    \includegraphics[width=0.19\textwidth]{../results/step2_results/mnist_cfg_1.0.png}
    \includegraphics[width=0.19\textwidth]{../results/step2_results/mnist_cfg_3.0.png}
    \includegraphics[width=0.19\textwidth]{../results/step2_results/mnist_cfg_5.0.png}
    \includegraphics[width=0.19\textwidth]{../results/step2_results/mnist_cfg_10.0.png}
