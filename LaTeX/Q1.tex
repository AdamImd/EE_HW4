...
begin{figure}[h]
    ...
    % 5x2 grid of images
    \begin{tabular}{ccccc}
        \includegraphics[width=0.18\textwidth]{images/step1_results/CelebA-HQ/unconditional.png} &
        \includegraphics[width=0.18\textwidth]{images/step1_results/CelebA-HQ/uncond_sample_2.png} &
        \includegraphics[width=0.18\textwidth]{images/step1_results/CelebA-HQ/uncond_sample_3.png} &
        \includegraphics[width=0.18\textwidth]{images/step1_results/CelebA-HQ/uncond_sample_4.png} &
        \includegraphics[width=0.18\textwidth]{images/step1_results/CelebA-HQ/uncond_sample_5.png} \\
