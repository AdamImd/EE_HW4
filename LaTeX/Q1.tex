...
I implemened the DDIM from HW3, the results are shown in Figure\~\ref{fig:uncond_samples}.

begin{figure}[h]
    \centering
    % 5x2 grid of images
    \begin{tabular}{ccccc}
        \includegraphics[width=0.18\textwidth]{images/step1_results/CelebA-HQ/unconditional/sample_1.png} &
        \includegraphics[width=0.18\textwidth]{images/step1_results/CelebA-HQ/unconditional/sample_2.png} &
        \includegraphics[width=0.18\textwidth]{images/step1_results/CelebA-HQ/unconditional/sample_3.png} &
        \includegraphics[width=0.18\textwidth]{images/step1_results/CelebA-HQ/unconditional/sample_4.png} &
        \includegraphics[width=0.18\textwidth]{images/step1_results/CelebA-HQ/unconditional/sample_5.png} \\
        \includegraphics[width=0.18\textwidth]{images/step1_results/ImageNet/unconditional/sample_1.png} &
        \includegraphics[width=0.18\textwidth]{images/step1_results/ImageNet/unconditional/sample_2.png} &
        \includegraphics[width=0.18\textwidth]{images/step1_results/ImageNet/unconditional/sample_3.png} &
        \includegraphics[width=0.18\textwidth]{images/step1_results/ImageNet/unconditional/sample_4.png} &
...
I found that an ILVR weight of 0.8 worked well during initial tests, so I used that value for all tasks. 

\begin{figure}
    \centering
    % 4 columns: SRx4, SRx8, Random Inpainting, Box Inpainting
    \begin{tabular}{cccc}
        % SRx4
        \begin{tabular}{c}
            \includegraphics[width=0.22\textwidth]{images/step1_results/CelebA-HQ/ILVR/SR_x4/recon_1.png} \\
            \includegraphics[width=0.22\textwidth]{images/step1_results/CelebA-HQ/ILVR/SR_x4/recon_2.png} \\
            \includegraphics[width=0.22\textwidth]{images/step1_results/CelebA-HQ/ILVR/SR_x4/recon_3.png} \\
        \end{tabular} &
        % SRx8
        \begin{tabular}{c}
            \includegraphics[width=0.22\textwidth]{images/step1_results/CelebA-HQ/ILVR/SR_x8/recon_1.png} \\
            \includegraphics[width=0.22\textwidth]{images/step1_results/CelebA-HQ/ILVR/SR_x8/recon_2.png} \\
            \includegraphics[width=0.22\textwidth]{images/step1_results/CelebA-HQ/ILVR/SR_x8/recon_3.png} \\
        \end{tabular} &
        % Random Inpainting
        \begin{tabular}{c}
            \includegraphics[width=0.22\textwidth]{images/step1_results/CelebA-HQ/ILVR/Inpainting_random_80pct/recon_1.png} \\
            \includegraphics[width=0.22\textwidth]{images/step1_results/CelebA-HQ/ILVR/Inpainting_random_80pct/recon_2.png} \\
            \includegraphics[width=0.22\textwidth]{images/step1_results/CelebA-HQ/ILVR/Inpainting_random_80pct/recon_3.png} \\
        \end{tabular} &
        % Box Inpainting
        \begin{tabular}{c}
            \includegraphics[width=0.22\textwidth]{images/step1_results/CelebA-HQ/ILVR/Inpainting_box/recon_1.png} \\
            \includegraphics[width=0.22\textwidth]{images/step1_results/CelebA-HQ/ILVR/Inpainting_box/recon_2.png} \\
            \includegraphics[width=0.22\textwidth]{images/step1_results/CelebA-HQ/ILVR/Inpainting_box/recon_3.png} \\
        \end{tabular} \\
    \end{tabular}
    \caption{ILVR Reconstructions on CelebA-HQ}.
